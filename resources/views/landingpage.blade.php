...
<body>
        ...
        <section class="cs-hero cs-style1 cs-bg" data-src="assets/img/hero_bg.svg">
            <div class="container">
                <div class="cs-hero_img">
                    ...
                    <img src="{{ asset('assets/images/Logo Kamera Comparison3.png') }}" alt="Hero Image"
                        class="wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.4s">
                </div>
    ...
    <section id="tutorial" class="cs-bg" data-src="assets/img/feature_bg.svg">
        ...
        <div class="container">
            <div class="cs-seciton_heading cs-style1 text-center">
                ...
                <h3 class="cs-section_title">List Kamera</h3>
            </div>
            <div class="cs-height_50 cs-height_lg_40"></div>
            <div class="row d-flex flex-row flex-nowrap row-horizon">
                <div class="col-md-6 col-xl-3">
                    <div class="cs-height_25 cs-height_lg_0"></div>
                    <div class="cs-iconbox cs-style1">
                        <img src="{{ asset('assets/images/kamera13.png') }}" class="card-img-top" alt="...">
                        <div class="cs-iconbox_in">
                            <h3 class="cs-iconbox_title">Kamera Canon</h3>
                            <div class="cs-iconbox_subtitle"> Rp 12000000
                            </div>
                            <br>
                        </div>
                        <span class="cs-btn cs-color1 cs-modal_btn" data-modal="register"><span>Detail</span></span>
                    </div>
                </div>
                <div class="col-md-6 col-xl-3">
                    <div class="cs-height_25 cs-height_lg_0"></div>
    ...
    <section id="tutorial" class="cs-bg" data-src="assets/img/feature_bg.svg">
        ...
        <div class="container">
            <div class="cs-seciton_heading cs-style1 text-center">
                <div class="cs-section_subtitle wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.3s">Cameris
                </div>
                <div class="cs-height_10 cs-height_lg_10"></div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="cs-footer_item">
                        ...
                        <div class="cs-social_btns cs-style1">
                            ...
                            <a href="#"><img src="{{ asset('assets/img/instagram.svg') }}"
                                    alt="Instagram"></a>
                        </div>
                    </div>
                </div><!-- .col -->
            ...
            <div class="cs-modal_container cs-white_bg">
                ...
                <div class="cs-login">
                    <div class="cs-login_left">
                        <img src="{{ asset('assets/images/kamera16.jpg') }}" alt="Login Thumb">
                    </div>
                ...
                <div class="cs-login">
                    ...
                    <div class="cs-login_right">
                        <form class="cs-login_form">
                            ...
                            <div class="cs-height_30 cs-height_lg_30"></div>
                            <div class="cs-or"><span>Spesifikasi Kamera</span></div>
        ...
        <div class="cs-modal_in">
            <div class="cs-modal_container cs-white_bg">
                ...
                <div class="cs-blog_details">
                    ...
                    <img src="{{ asset('assets/img/post_details_1.jpeg') }}" alt="Details"
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <img src="{{ asset('assets/img/post_details_2.jpeg') }}" alt="Details"
                                class="cs-radius_10 w-100">
                        </div>
                        <div class="col-lg-6">
                            <img src="{{ asset('assets/img/post_details_3.jpeg') }}" alt="Details"
                                class="cs-radius_10 w-100">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <img src="{{ asset('assets/img/post_details_4.jpeg') }}" alt="Details"
                                class="cs-radius_10 w-100">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="cs-comment_wrapper">
                        ...
                        <ol class="comment-list">
                            <li>
                                <div class="comment-body">
                                    <div class="comment-author">
                                        <img alt="Avatar" src="{{ asset('assets/img/avatar_4.png') }}"
                                            class="avatar">
                                ...
                                <ol class="children">
                                    <li>
                                        <div class="comment-body">
                                            <div class="comment-author">
                                                <img alt="Avatar" src="{{ asset('assets/img/avatar_5.png') }}"
                                                    class="avatar">
                            ...
                            <li>
                                <div class="comment-body">
                                    <div class="comment-author">
                                        <img alt="Avatar" src="{{ asset('assets/img/avatar_6.png') }}"
                                            class="avatar">
